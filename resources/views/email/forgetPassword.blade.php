						...
						<tr style="border-collapse:collapse">
							<td align="center" style="padding:0;Margin:0">
								<table class="es-header-body"
									style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#621e95;width:600px"
									...
									<tr style="border-collapse:collapse">
										<td align="center"
											...
											<!-- <img src="https://www.indigofur.com.au/wp-content/uploads/2022/09/footer-logo.png"
												alt="indigofur logo"
												style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
												title="indigofur logo" height="80"> -->
														...
														<table width="100%" cellspacing="0" cellpadding="0"
															...
															<tr style="border-collapse:collapse">
																<td align="left"
                                                                    ...
                                                                    <a href="http://onerous-grade.surge.sh/reset-password/?token={{$details['token']}}" target="_blank" > Change Password </a>
																</td>
															</tr>
														</table>
													</td>
						...
						<tr style="border-collapse:collapse">
							<td align="center" style="padding:0;Margin:0">
								<table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
									...
									<tr style="border-collapse:collapse">
										<td align="left"
											style="Margin:0;padding-top:35px;padding-left:35px;padding-right:35px;padding-bottom:40px; background-color: #621e95;">
											<table width="100%" cellspacing="0" cellpadding="0"
												style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
												<tr style="border-collapse:collapse">
													<td valign="top" align="center"
															...
															<tbody>
																<tr>
																	<td align="center" valign="top" class="es-p10r">
																		<a target="_blank" href="https://www.facebook.com/indigofur1">
																	...
																	<td align="center" valign="top" class="es-p10r">
																		<a target="_blank" href="https://www.instagram.com/indigofur1/">
